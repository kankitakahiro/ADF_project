...
from my_utils.deep_search import reduce_g_diff_and_fly
    ...
    for num in range(len(inputs)):
        ...
        for iter in range(max_iter+1):
            ...
            if origin_label == label and origin_label == n_label:
                ...
                result = reduce_g_diff_and_fly(sess, x, preds, g_diff, previous_sample, s_grad, data_config, dataset, perturbation_size, sensitive_param,column_frequencies)
